...
Examples:
  node scripts/generate_resume_pdf.mjs ../../tech-resume-generator_files/output/general_generated_resume.json
  npm run generate-resume -- ../../tech-resume-generator_files/output/tailored_generated_resume.json
